...
public class MyProgressView extends View {
    ...
    public void setProgress(float progress) {
        ...
        if (progress > 0 && progress <= 400) {
            mLinePaint.setColor(getResources().getColor(R.color.red_ee));
            mCircleOutPaint.setColor(getResources().getColor(R.color.red_ee));
        } else if (progress > 400 && progress <= 700) {
            mLinePaint.setColor(getResources().getColor(R.color.orange_f7));
            mCircleOutPaint.setColor(getResources().getColor(R.color.orange_f7));
        } else if (progress > 700 && progress <= 900) {
            mLinePaint.setColor(getResources().getColor(R.color.green_5d));
            mCircleOutPaint.setColor(getResources().getColor(R.color.green_5d));
        } else if (progress > 900) {
            mLinePaint.setColor(getResources().getColor(R.color.blue_2e));
            mCircleOutPaint.setColor(getResources().getColor(R.color.blue_2e));
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("初级志愿者", margin + circleOutRadius - getTextWidth("初级志愿者"), height / 2 + 50, mTvPaint);
        canvas.drawText("中级志愿者", margin + circleOutRadius * 3 + realWidth - getTextWidth("中级志愿者"), height / 2 + 50, mTvPaint);
        canvas.drawText("高级志愿者", margin + circleOutRadius * 5 + realWidth * 2 - getTextWidth("高级志愿者"), height / 2 + 50, mTvPaint);
        canvas.drawText("骨灰志愿者", margin + circleOutRadius * 7 + realWidth * 3 - getTextWidth("骨灰志愿者"), height / 2 + 50, mTvPaint);
        float ratio;
        float result = 0;
